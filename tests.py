...
class TestACController(unittest.TestCase):
    ...
    def test_change_channel_due_to_conflict(self):
        ...
        self.assertNotEqual(self.ap1.channel, self.ap2.channel)  # The channels should now be different if there was a conflict
...
class TestParseInput(unittest.TestCase):
    ...
    def test_parse_input_file(self):
        ...
        self.parser.input_parse(sys.stdin)
